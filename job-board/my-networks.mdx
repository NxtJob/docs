...
- **Hiring Team** — A hiring manager or team lead involved in the hiring decision
...
| **Connection Type** | Potential Referer, Hiring Team, Top Management |
...
The Sent and Accepted column headers include a **Sync LinkedIn** button. This triggers a sync with your LinkedIn account to check whether pending connection requests have been accepted. The Chrome Extension assists with fetching the latest connection status.
